...
public class EpicerieActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Handle the click.
                Intent intent = new Intent(EpicerieActivity.this,ProximityActivity.class);
    ...
    protected void onResume() {
        ...
        FirebaseUtil.openFbReference("collected_data",EpicerieActivity.this);
        RecyclerView rvDatas = (RecyclerView) findViewById(R.id.rvData);
        final DataAdapter adapter = new DataAdapter("Grocery");
