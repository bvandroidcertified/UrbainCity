...
public class ProximityActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setSelectedItemId(R.id.ubrcity_proximite);
    ...
    private class LoadImage extends AsyncTask<String,Void,Bitmap> {
        ...
        protected Bitmap doInBackground(String... strings) {
            ...
            mBmp = null;
            try {
                mBmp = Picasso.with(ProximityActivity.this).load(urlString).get();
            } catch (IOException e) {
                e.printStackTrace();
            }
            return mBmp;
