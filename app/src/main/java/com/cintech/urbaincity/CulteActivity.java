...
public class CulteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Handle the click.
                Intent intent = new Intent(CulteActivity.this,ProximityActivity.class);
    ...
    protected void onResume() {
        ...
        FirebaseUtil.openFbReference("collected_data",CulteActivity.this);
        RecyclerView rvDatas = (RecyclerView) findViewById(R.id.rvData);
        final DataAdapter adapter = new DataAdapter("Cult");
